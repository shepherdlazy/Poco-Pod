Pod::Spec.new do |s|
  ...
  # ――― Source Location ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  s.source       = { :http => "https://github.com/shepherdlazy/Poco-Pod/releases/download/v1.8.1/poco-1.8.1-minimal-sdk11.2.tar.gz", :sha256 => "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855" }
